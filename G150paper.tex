...
For our radiation models, we fixed the ambient gas density and tested several values (as informed by the values determined in $\S$\ref{G150:Xray}) for proton-proton and bremsstrahlung interactions. For IC emission, we include a CMB, FIR, and NIR component.  \jamie{Talk about free/ fixed params of the model, reference the table, and figure to show best fit, discuss results and what the fits imply regarding lep/had dom and energy in e- p.}
