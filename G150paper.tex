...
\jamie{naima to do:Add bremss. properly scale the radio flux density. should I be using a power law particle dist function because I have a power law photons spec? increase walker number burn in and runs?Do the energetics make sense? Are there params that I can fix? Kep, B? Any reason to have different n? Liz had doubts about the pp component extending to such high energy, is this really an issue?}
