...
Have a working model using naiama. What more needs to be done?

Add bremss. properly scale the radio flux density. Talk to Dan about whether it makes sense. Are there params that I can fix? Kep, B? Any reason to have different n? Liz had doubts about the pp component extending to such high energy, is this really an issue?
