...
\begin{figure}[!ht]
	\begin{centering}
		...
		\includegraphics[width=\columnwidth]{{G150_1GeV_resTsmapNoG150_radio_noLabs}.pdf}
		\caption{Background subtracted residual TS map above 1 GeV with 0.1$^\circ$x 0.1$^\circ$ pixels for fixed index $\Gamma$ = 2, centered on SNR \Gone. The orange circle and translucent shading show the fit disk radius and 1$\sigma$ errors, respectively, for the extended source, the orange cross shows the position of 3FGL J0426.7+5437 (included in the background model), and blue dashed circle is the extent of the radio SNR. Bottom includes \Gone in the background model, top does not.
